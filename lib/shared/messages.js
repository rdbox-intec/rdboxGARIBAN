...
module.exports = {
  ...
  warning: {
    ...
    exitWhileFlashing: () => {
      return [
        ...
        'Closing Gariban may leave your drive in an unusable state.'
      ].join(' ')
    },
  ...
  error: {
    ...
    validation: () => {
      return [
        'The write has been completed successfully but Gariban detected potential',
    ...
    driveUnplugged: () => {
      return [
        'Looks like Gariban lost access to the drive.',
    ...
    inputOutput: () => {
      return [
        'Looks like Gariban is not able to write to this location of the drive.',
    ...
    childWriterDied: () => {
      return [
        ...
        'Please try again, and contact the Gariban team if the problem persists.'
      ].join(' ')
    }
