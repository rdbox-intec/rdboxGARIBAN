 ...
 */
exports.getIndexOfFiles = (uds, id) => {
  return constructionUD.getIndexOfFiles(uds, id)
}

exports.pushNewUserData = (uds, id, comment) => {
  constructionUD.pushNewUserData(uds, id, comment)
}

exports.setFromPathOfFiles = (uds, id, fromPath) => {
  constructionUD.setFromPathOfFiles(uds, id, fromPath)
}

exports.setHostnameOfCurrentCluster = (uds, hostname) => {
  constructionUD.setHostnameOfCurrentCluster(uds, hostname)
}

exports.setIndexOfCurrentCluster = (uds, indexNo) => {
  constructionUD.setIndexOfCurrentCluster(uds, indexNo)
}

exports.dumpYaml = (uds) => {
  return constructionUD.dumpYaml(uds)
}

exports.resetHostnameFlg = (uds) => {
  constructionUD.resetHostnameFlg(uds)
}

exports.setHostnameFlg = (uds) => {
  constructionUD.setHostnameFlg(uds)
}

exports.getListOfUserData = (uds) => {
  return constructionUD.getListOfUserData(uds)
}

exports.getUsernameOfRoot = (uds) => {
  return constructionUD.getUsernameOfRoot(uds)
}

exports.getPublicKeyOfRoot = (uds) => {
  return constructionUD.getPublicKeyOfRoot(uds)
}

exports.getSecretKeyOfRoot = (uds) => {
  return constructionUD.getSecretKeyOfRoot(uds)
}

exports.getClusterIdByIndex = (uds, indexNo) => {
  return constructionUD.getClusterIdByIndex(uds, indexNo)
}
