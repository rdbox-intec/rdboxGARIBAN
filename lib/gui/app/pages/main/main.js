 ...
 *
 * @module Gariban.Pages.Main
 */

const angular = require('angular')
const MODULE_NAME = 'Gariban.Pages.Main'
...
const MainPage = angular.module(MODULE_NAME, [
  ...
  require('../../components/userdata-setter/userdata-setter'),
  ...
  require('../../components/userdata-setter'),
...
MainPage.controller('UserdataSettingController', require('./controllers/userdata-setting'))
