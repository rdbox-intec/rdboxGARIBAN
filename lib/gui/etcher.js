...
const configUrl = settings.get('configUrl') || 'https://raw.githubusercontent.com/rdbox-intec/rdboxGARIBAN/rdbox-config/remote-config.json'
...
/**
 * @summary Create Gariban's main window
 * @example
...
const createMainWindow = () => {
  const mainWindow = new electron.BrowserWindow({
    ...
    width: parseInt(config.width, 10) || 1000,
    // eslint-disable-next-line no-magic-numbers
    height: parseInt(config.height, 10) || 580,
