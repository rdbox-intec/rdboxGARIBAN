 ...
 * @public
 *
 * @param {{Object}} config - drive device
 *
 * @example
 * selectionState.setConfig();
 */
exports.setConfig = (config) => {
  store.dispatch({
    type: store.Actions.SET_CONFIG,
    data: config
  })
}
 ...
 *
 * @example
 * const config = selectionState.getConfig();
 */
exports.getConfig = () => {
  return _.get(store.getState().toJS(), [ 'selection', 'config' ])
}
