...
/**
 * @module Gariban.Models.Userdata
 */
...
exports.setHttpProxy = (referrer, stringOfProxy) => {
  constructionUD.setHttpProxy(referrer, stringOfProxy)
}

exports.setNoProxy = (referrer, stringOfProxy) => {
  constructionUD.setNoProxy(referrer, stringOfProxy)
}

exports.updateUpdateDateOfCluster = (referrer) => {
  constructionUD.updateUpdateDateOfCluster(referrer)
}

exports.addSuffixForRoleToTheClusterData = (referrer, role, id, parent) => {
  constructionUD.addSuffixForRoleToTheClusterData(referrer, role, id, parent)
}
...
exports.getWpaBeOfWriteFiles = (referrer) => {
  return constructionUD.getWpaBeOfWriteFiles(referrer)
}

exports.getWpaApanOfWriteFiles = (referrer) => {
  return constructionUD.getWpaApanOfWriteFiles(referrer)
}

exports.getWpaApbgOfWriteFiles = (referrer) => {
  return constructionUD.getWpaApbgOfWriteFiles(referrer)
}

exports.getHostapdBeOfWriteFiles = (referrer) => {
  return constructionUD.getHostapdBeOfWriteFiles(referrer)
}

exports.getHostapdApanOfWriteFiles = (referrer) => {
  return constructionUD.getHostapdApanOfWriteFiles(referrer)
}

exports.getHostapdApbgOfWriteFiles = (referrer) => {
  return constructionUD.getHostapdApbgOfWriteFiles(referrer)
}

exports.getHttpProxy = (referrer) => {
  return constructionUD.getHttpProxy(referrer)
}

exports.getNoProxy = (referrer) => {
  return constructionUD.getNoProxy(referrer)
}

exports.getVpnBridgeOfWriteFiles = (referrer) => {
  return constructionUD.getVpnBridgeOfWriteFiles(referrer)
}

exports.getKubeadmnJoinArgsOfRuncmd = (referrer) => {
  return constructionUD.getKubeadmnJoinArgsOfRuncmd(referrer)
}

exports.getBranchParentArray = (referrer) => {
  return constructionUD.getBranchParentArray(referrer)
}
