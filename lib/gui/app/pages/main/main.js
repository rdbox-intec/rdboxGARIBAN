...
const MainPage = angular.module(MODULE_NAME, [
  ...
  require('../../components/config-setter/config-setter'),
  ...
  require('../../components/config-setter'),
...
MainPage.controller('ConfigSettingController', require('./controllers/config-setting'))
